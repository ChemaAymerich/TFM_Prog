"""
Django settings for Proyecto_TFM project.
...
SECRET_KEY = 'django-insecure-%3yb489_(ypkrefti@nh^o=gfk6!a^%hkhu(*9rv(w+d5r-*9@'
...
ROOT_URLCONF = 'Proyecto_TFM.urls'
...
WSGI_APPLICATION = 'Proyecto_TFM.wsgi.application'
